<!-- 
      * Página RecuperarSenha *
          ...
          Funções:
            - Inserir o email para recuperação da senha
            - Avançar na recuperação da senha
            - Voltar para LoginCadastro 
            - Enviar email com o token para troca de senha ao clicar em avançar (caso o email esteja correto)
-->
